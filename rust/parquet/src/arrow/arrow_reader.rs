...
mod tests {
    ...
    use crate::column::reader::GetColumnReader;
    use crate::column::writer::{get_typed_column_writer_mut, GetColumnWriter};
    use crate::data_type::{BoolType, ByteArray, ByteArrayType, Int32Type};
    ...
    fn single_column_reader_test<T, A, C, G>(
        ...
        T: GetColumnReader + GetColumnWriter,
        G: RandGen<T>,
    ...
    fn generate_single_column_file_with_data<T: GetColumnReader + GetColumnWriter>(
        values: &Vec<Vec<T::T>>,
        path: &Path,
        schema: TypePtr,
    ) -> Result<()> {
